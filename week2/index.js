...
let bonusRate = 0.1; // 設定基本獎金為 10%
if (coachIncome > 100000 && coachIncome <= 300000) bonusRate = 0.15; // 業績超過100000到300000以下區間, 獎金為 15%
if (coachIncome > 300000 ) bonusRate = 0.2; // 超過300000 獎金為 20%
...
let calorieBurn = 0;
calorieBurn += activties.bicycle.calorieBurnPerMin * 10
calorieBurn += activties.treadmill.calorieBurnPerMin * 30
calorieBurn += activties.yoga.calorieBurnPerMin * 40
calorieBurn += activties.bicycle.calorieBurnPerMin * 10
